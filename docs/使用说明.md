...
- `docs/design.md` — 架构与威胁模型
- `docs/使用说明.md` — 本文档
- `docs/2026-08-18-启动崩溃问题修复报告.md` / `docs/2026-08-20-install-gate启动崩溃修复报告.md` — 崩溃修复记录
- `docs/2026-08-20-web-ui-优化记录.md` — Web UI 模块开发与问题记录
- `docs/2026-08-20-跨机安装崩溃排查与加固报告.md` — 跨机安装排查与加固
